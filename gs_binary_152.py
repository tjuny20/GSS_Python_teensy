...
def build_152_expansion(sensor_data, h):
    """Build 152-trace expansion: 8 raw + 8 d1 + 8 d2 + 64 diff + 64 ratio."""
    ...
    return np.hstack([x_d12, d64, r64])  # 24 + 64 + 64 = 152


train_expanded = build_152_expansion(train_data_raw, h_train)
test_expanded  = build_152_expansion(test_data_raw, h_test)
