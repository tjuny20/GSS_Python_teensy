...
# ── Build config: ∂¹+∂² + 56R + 56D  (136 traces) ──────────────────────
def build_configs(sensor_data, h, n_sensors):
    """Return the single ∂¹+∂² + 56R + 56D expansion (136 traces)."""
    ...
    configs = {
        '∂¹+∂² + 56R + 56D': np.hstack([x_d12, r56, d56]),
    }
    return configs
