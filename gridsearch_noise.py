...
import pickle
from tools import load, estimate_derivative, pseudoderivative, add_white_noise_cols
...
with open('data/gridsearch_whitenoise.pkl', 'wb') as f:
    pickle.dump(data, f)