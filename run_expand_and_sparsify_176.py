...
#!/usr/bin/env python3
"""
Expand-and-sparsify gridsearch for GPU server — 176-trace expansion.
...
Usage:
    python run_expand_and_sparsify_176.py
"""
...
# ── Build 176-trace config for a given dataset ─────────────────────────
def build_configs(sensor_data, h, n_sensors):
    """Return the 176-trace expansion config + pair pools.

    176 = 8 raw + 7*8 derivatives (orders 1-7) + 56 ratios + 56 differences
    """
    ...
    configs = {
        '\u2202\u00b9\u207b\u2077 + 56R + 56D':  np.hstack([x_d1234567, r56, d56]),
    }
    return configs
