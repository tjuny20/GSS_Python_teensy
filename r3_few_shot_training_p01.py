"""Stand-alone training script for the R3 few-shot learning notebook (p=0.1).

Identical to ``r3_few_shot_training.py`` except the Hebbian learning rate
is set to P = 0.1 instead of 0.01.  Results are saved to
``data/r3_few_shot_results_p01.pkl``.

Usage
-----
    python r3_few_shot_training_p01.py
"""
...
OUT_PATH = 'data/r3_few_shot_results_p01.pkl'
