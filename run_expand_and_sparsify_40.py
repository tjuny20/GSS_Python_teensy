...
# ── Build config: ∂¹+∂² + 8R + 8D  (40 traces) ─────────────────────────
def build_configs(sensor_data, h, n_sensors):
    """Return the single ∂¹+∂² + 8R + 8D expansion (40 traces)."""
